    ...
    <div class="form-container">
        <div class="panel panel-default mb-0">
            <div class="panel-wrapper">
                ...
                <?php } ?>
                <h4 class="mb-4">Congratulations, Your installation is done. Your pharmacy management system is ready!</h4>
            </div>
            <div class="panel-footer pl-0 pr-0 pb-0">
                <div class="text-center">
                    <a href="../" class="btn btn-outline btn-primary btn-pill btn-outline-2x m-1"><i class="fas fa-globe mr-2"></i> Login Now</a>
                </div>
            </div>
        </div>
